...
Puppet::Functions.create_function(:'ibvs::infoblox::get_ip_ref') do
  dispatch :func do
    param 'String', :ip
    param 'Hash', :infoblox
    return_type 'String'
  ...
  def func(ip, infoblox)
    url = infoblox['wapi_url'] + "/ipv4address?status=USED&ip_address=#{ip}"
